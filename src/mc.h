...
typedef char       mc_char_t;   /**< Character type. */
typedef int64_t    mc_int_t;    /**< Int type (64-bits). */
typedef uint64_t   mc_uint_t;   /**< Unsigned int type (64-bits). */
typedef int64_t    mc_size_t;   /**< Size of allocation type. */

typedef mc_int_t*  mc_int_p;    /**< Int ptr type. */
